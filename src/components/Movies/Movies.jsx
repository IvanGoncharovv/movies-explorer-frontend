...
import { localStorageConst, errorText } from "../../const/const";
...
function Movies({loggedIn}) {
  ...
  return (
    <main className="content">
      ...
      ><FilterCheckbox checked={isShortFilms} onChange={onCheckboxChangeMovies}/> </SearchForm> :
        <SearchForm 
        ...
        ><FilterCheckbox checked={isShortFilmsSavedMovies} onChange={onCheckboxChangeSavedMovies}/> </SearchForm>
      }
      {isLoader && <Preloader />}
